 ...
 * @param {Function} onUpdateQueuedStatus - A function that updates the post's status.
 */
...
const mapSelectToProps = ( mapSelect ) => ( {
	isQueued:
		mapSelect( 'core/editor' ).getEditedPostAttribute( 'status' ) ===
		'queued',
} );
